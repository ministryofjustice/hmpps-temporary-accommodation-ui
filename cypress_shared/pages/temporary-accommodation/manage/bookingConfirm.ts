import type { Cas3Bedspace, Cas3Premises, Person } from '@approved-premises/api'
...
export default class BookingConfirmPage extends Page {
  ...
  constructor(premises: Cas3Premises, bedspace: Cas3Bedspace, person: Person) {
    super('Confirm CRN')
  ...
  static visit(premises: Cas3Premises, bedspace: Cas3Bedspace, person: Person): BookingConfirmPage {
