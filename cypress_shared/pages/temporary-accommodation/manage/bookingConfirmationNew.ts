import type { Booking, Cas3Bedspace, NewConfirmation, Premises } from '@approved-premises/api'
...
export default class BookingConfirmationNewPage extends Page {
  ...
  static visit(premises: Premises, bedspace: Cas3Bedspace, booking: Booking): BookingConfirmationNewPage {
    cy.visit(
