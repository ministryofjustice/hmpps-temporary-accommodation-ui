...
import { arrivalFactory, cas3BookingFactory, newArrivalFactory } from '../../../../server/testutils/factories'
...
Given('I mark the booking as arrived', () => {
  cy.then(function _() {
    ...
    const bookingArrivalPage = Page.verifyOnPage(BookingArrivalNewPage, this.premises, this.bedspace, this.booking)
...
Then('I should see a list of the problems encountered marking the booking as arrived', () => {
  cy.then(function _() {
    const page = Page.verifyOnPage(BookingArrivalNewPage, this.premises, this.bedspace, this.booking)
...
Then('I should see a list of the problems encountered whilst changing the booking arrival', () => {
  cy.then(function _() {
    const page = Page.verifyOnPage(BookingArrivalEditPage, this.premises, this.bedspace, this.booking)
