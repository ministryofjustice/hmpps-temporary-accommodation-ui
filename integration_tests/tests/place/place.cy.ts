...
import { cas3BedspaceFactory, cas3PremisesFactory, placeContextFactory } from '../../../server/testutils/factories'
...
context('Place', () => {
  ...
  it('allows the user progress along the "place" journey', () => {
    ...
    const placeHelper = new PlaceHelper(placeContext, premises, cas3Bedspace)
