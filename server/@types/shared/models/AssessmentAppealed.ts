...
export type AssessmentAppealed = {
    /**
    ...
    /**
     * The UUID of an appeal for an application
     */
    appealId: string;
    /**
     * The URL on the Approved Premises service at which a user can view a representation of an appeal and related resources
     */
    appealUrl: string;
