...
/* tslint:disable */
/* eslint-disable */
import type { RequestForPlacementAssessed } from './RequestForPlacementAssessed';
export type RequestForPlacementAssessedEnvelope = {
    /**
    ...
    eventDetails: RequestForPlacementAssessed;
};
