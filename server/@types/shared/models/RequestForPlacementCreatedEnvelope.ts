...
/* tslint:disable */
/* eslint-disable */
import type { RequestForPlacementCreated } from './RequestForPlacementCreated';
export type RequestForPlacementCreatedEnvelope = {
    /**
    ...
    eventDetails: RequestForPlacementCreated;
};
