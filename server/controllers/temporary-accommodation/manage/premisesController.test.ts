...
describe('PremisesController', () => {
  ...
  describe('index', () => {
    it('searches online premises data and returns as table rows when no status parameter is provided', async () => {
      ...
      expect(premisesService.search).toHaveBeenCalledWith(callConfig, params.postcodeOrAddress, 'online', 'pdu')
    })
    ...
    it('returns zero archived properties data when no archived properties exist in database', async () => {
      ...
      expect(premisesService.search).toHaveBeenCalledWith(callConfig, params.postcodeOrAddress, 'archived', 'pdu')
    })
  ...
  it('searches premises data and returns as table rows when premisesSortBy is "la"', async () => {
    ...
    expect(premisesService.search).toHaveBeenCalledWith(callConfig, params.postcodeOrAddress, 'online', 'la')
  })
