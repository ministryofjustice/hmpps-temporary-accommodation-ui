...
export default class PremisesController {
  constructor(
    protected readonly premisesService: PremisesService,
    protected readonly bedspaceService: BedspaceService,
    protected readonly assessmentService: AssessmentsService,
  ) {}
  ...
  create(): RequestHandler {
    return async (req: Request, res: Response) => {
      const newPremises: NewPremises = {
        characteristicIds: [],
        ...req.body,
        turnaroundWorkingDayCount: parseNumber(req.body.turnaroundWorkingDayCount, { allowNegatives: true }),
      }
