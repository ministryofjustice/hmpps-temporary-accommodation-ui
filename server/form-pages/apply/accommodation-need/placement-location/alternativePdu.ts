...
export default class AlternativePdu implements TasklistPage {
  title = 'Is placement required in an different PDU (Probation Delivery Unit)?'
  ...
  response() {
    const translatedResponse: PageResponse = {
      'Is placement required in an different PDU?': sentenceCase(this.body.alternativePdu),
    }
