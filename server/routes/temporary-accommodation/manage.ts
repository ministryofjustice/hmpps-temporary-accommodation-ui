...
export default function routes(controllers: Controllers, services: Services, router: Router): Router {
  ...
  if (config.flags.managePropertiesV2Enabled) {
    ...
    get(paths.premises.v2.show.pattern, premisesControllerV2.show('premises'), { auditEvent: 'SHOW_PREMISES_V2' })
    get(paths.premises.v2.bedspaces.list.pattern, premisesControllerV2.show('bedspaces'), {
