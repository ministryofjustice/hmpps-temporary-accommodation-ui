...
const apiSpecPath = path.join(__dirname, '..', '..', 'tmp', 'cas3-api.json')

const apiSpecUrl =
  process.env.CAS3_API_SPEC_URL ||
  'https://approved-premises-api-dev.hmpps.service.justice.gov.uk/v3/api-docs/CAS3Shared'
